...
const Menu = ({
  ...
  return (
    <>
      <div className="scale-[0.8] max-w-[100%] bg-[#CBCCCF] shadow-mdm dark:bg-[#111111]  flex justify-center items-center gap-[1rem] px-0 pt-2 pb-2 rounded-[0.6rem] mx-0">
        <Brush
        ...
        <div className="py-[1rem] px-[1.5rem] rounded-[0.5rem] w-12 h-12 relative  shadow-vsm  hover:bg-[#B7BABF] text-black text-blackcursor-pointer">
          <input
            type="color"
            name="color"
            id="color"
