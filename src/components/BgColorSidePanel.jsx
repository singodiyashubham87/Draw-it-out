...
const BgColorSidePanel = ({ canvasRef, setBgColor }) => {
  return (
    <div className="color-pallet gsm:w-[5%] w-[85%] h-[50rem] p-2 grid grid-cols-6 vsm:grid-cols-4 gsm:grid-cols-1 gap-2 vsm:gap-4 gsm:gap-2 gsm:py-auto gsm:mb-8 px-8">
      <input
        type="color"
        name="color"
        id="color"
