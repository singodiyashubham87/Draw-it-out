...
import Footer from "./components/Footer"; // From addicons
import { FaRegEye, FaRegEyeSlash, FaMoon, FaSun } from "react-icons/fa"; // From main
import Joyride from "react-joyride"; // From main

const tourSteps = [ // From main
  {
    target: "body",
    placement: "center",
...
import { SiBuymeacoffee } from "react-icons/si"; // From main
